...
def odeint(func, y0, t, *, rtol=1e-7, atol=1e-9, method=None, options=None, event_fn=None, reflect_fn=None, reflect_velocity_fn=None):
    ...
    solver = SOLVERS[method](func=func, y0=y0, rtol=rtol, atol=atol, reflect_fn=reflect_fn, reflect_velocity_fn=reflect_velocity_fn, **options)
