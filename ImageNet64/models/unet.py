...
class Linear(torch.nn.Module):
    ...
    def forward(self, x):
        x = x.contiguous() @ self.weight.to(x.dtype).t().contiguous()
...
class DhariwalUNet(torch.nn.Module):
    ...
    def forward(self, t, x, y=None, augment_labels=None, drop_half_label=False, **kwargs):
        # Mapping.
    ...
    def forward_with_cfg(self, t, x, y=None, augment_labels=None, cfg_scale=1.0, **kwargs):
        """
        ...
        # model_out = self.forward(t, combined, y, augment_labels, drop_half_label=True)
